...
class GoogleOAuth2CallbackView(APIView):
    ...
    def get(self, request):
        ...
        app_tokens = google_oauth.getTokenForUser(user_info, google_tokens)

        url = f"http://127.0.0.1:5173/?access_token={str(app_tokens.access_token)}&refresh_token={str(app_tokens)}"
